...
class VideoStream:
    ...
    def __init__(self,resolution=(640,480),framerate=30):
        ...
        self.stream = cv2.VideoCapture(-1) # set up -1 to automatically select video device
...
parser.add_argument('--edgetpu', help='Use Coral Edge TPU Accelerator to speed up detection',
                    action='store_true')
parser.add_argument('--nogui', help='Disables output of GUI window',
                    action='store_true')
...
while True:
    ...
    cv2.putText(frame,'frame: {0}'.format(frame_count),(30,100),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,0),2,cv2.LINE_AA)
